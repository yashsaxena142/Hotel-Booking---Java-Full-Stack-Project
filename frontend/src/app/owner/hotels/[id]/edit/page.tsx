...
import { hotelApi, Hotel as HotelType, CreateHotelData } from '@/lib/hotelApi';
...
export default function EditHotelPage() {
  ...
  const fetchHotel = async () => {
    try {
      ...
      setImages(hotel.images?.length ? hotel.images : ['']);
    } catch (err: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const hotelData: Partial<CreateHotelData> = {
        name: formData.name,
      ...
      await hotelApi.update(hotelId, hotelData);
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
          ...
          <main className="flex-grow flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">Loading hotel details...</p>
            </div>
          </main>
          <Footer />
        </div>
            ...
            <div className="container mx-auto px-4 py-12">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-indigo-100">Update your hotel information</p>
                </div>
              </div>
            </div>
          </div>
